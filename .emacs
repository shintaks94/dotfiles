...
;; ruby-electric.el
(add-hook 'ruby-mode-hook (lambda () (setq ruby-electric-mode t)))
...
(add-hook 'ruby-mode-hook (lambda () (setq ruby-block-mode t)))

;; gist.el
(require 'gist)

(require 'tabbar)
(global-set-key (kbd "C-z C-n") 'tabbar-forward)
(global-set-key (kbd "C-z C-p") 'tabbar-backward)
